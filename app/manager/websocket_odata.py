...
# Status: Active
# Dependent: TRUE
# Note: This server handles O Data (range/hallway) streaming for ParcoRTLS, using O Data Raw FS (i_typ_res=3).
            ...
            try:
                ...
                if msg_type == "HeartBeat":
                    ...
                    if req.req_type == RequestType.BeginStream:
                        ...
                        resp.message = "Request not supported in OData stream."
                        await websocket.send_text(resp.to_json())
