# Name: websocket_sensordata.py
# Version: 0.1.1
# Created: 250516
# Modified: 250704
# Creator: ParcoAdmin
# Modified By: ParcoAdmin
# Description: Python script for ParcoRTLS SensorData WebSocket server on port 8007
# Location: /home/parcoadmin/parco_fastapi/app/manager
# Role: Backend
# Status: Active
# Dependent: TRUE
# Note: This server handles sensor data streaming for ParcoRTLS, using Sensor Data FS (i_typ_res=12).
...
STREAM_TYPE = "SensorData"
RESOURCE_TYPE = 12  # Sensor Data FS
...
async def websocket_endpoint_sensordata(websocket: WebSocket, manager_name: str):
            ...
            try:
                ...
                if msg_type == "HeartBeat":
                    ...
                    if req.req_type == RequestType.BeginStream:
                        ...
                        resp.message = "Request not supported in SensorData stream."
                        await websocket.send_text(resp.to_json())
