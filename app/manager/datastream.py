...
import websockets
import httpx
from .enums import ConnectionState, TriggerDirections, RequestType
from .models import Tag, GISData, HeartBeat, Request, Response
from .trigger import Trigger
from .utils import FASTAPI_BASE_URL, MessageUtilities
from .region import Region3D, Region3DCollection
from .events import StreamDataEventArgs, StreamHeartbeatEventArgs, StreamResponseEventArgs, StreamConnectionEventArgs  # Updated import
...
class DataStream:
    ...
    async def send_request(self, req: Request):
        ...
        await self.websocket.send(req.to_xml())
    ...
    async def live_data_arrived(self, str_xml: str):
        self.buffer += str_xml
        temp = ""
        ...
        for i in range(len(messages)):
            ...
            if len(msg) > 0 and MessageUtilities.ParcoEndTag in msg:
                ...
                if "<type>HeartBeat</type>" in msg:
                    ...
                    await self.websocket.send_text(MessageUtilities.XMLDefTag + msg)  # Echo back
